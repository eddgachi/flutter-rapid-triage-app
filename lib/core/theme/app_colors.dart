...
class AppColors {
  ...
  static const Color p3Delayed = Color(0xFFFFD700);
  static const Color p4Expectant = Color(0xFF313034);
  static const Color p5Minor = Color(0xFF0052CC);

  // Sync Status Colors
  static const Color synced = Color(0xFF2E7D32);
  static const Color pending = Color(0xFFED6C02);
  static const Color failed = Color(0xFFBA1A1A);
}
