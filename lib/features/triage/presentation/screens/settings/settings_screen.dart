              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Settings',
                        style: AppTypography.textTheme.headlineMedium?.copyWith(color: AppColors.onSurface)),
                    const SizedBox(height: 24),
                    _buildProfile(),
                    const SizedBox(height: 24),
                    _buildSection('Organization', children: [
                      _SettingTile(
                    ...
                    const SizedBox(height: 24),
                    _buildSection('Preferences', children: [
                      _SettingToggle(
                    ...
                    const SizedBox(height: 24),
                    _buildSection('Hardware Integrations', children: [
                      _SettingToggle(
                    ...
                    const SizedBox(height: 24),
                    _buildSection('Data & Synchronization', children: [
                      _SettingToggle(
                        icon: Icons.sync,
                    ...
                    const SizedBox(height: 24),
                    _buildSection('Device Storage', children: [
                      _SettingTile(
                        icon: Icons.download,
                    ...
                    Center(
                      child: Column(
                        children: [
                          Text('RapidTriage Emergency Protocol Suite',
                              style: AppTypography.textTheme.labelMedium?.copyWith(
                                color: AppColors.onSurfaceVariant,
                              )),
                          Text('Version 4.12.0 (Build 8829)',
                              style: AppTypography.textTheme.labelMedium?.copyWith(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: AppTypography.textTheme.bodyLarge?.copyWith(color: AppColors.onSurface)),
                if (subtitle != null) Text(subtitle!,
                    style: AppTypography.textTheme.bodyMedium?.copyWith(color: AppColors.onSurfaceVariant)),
              ],
            ),
          ),
          if (trailing != null) Icon(trailing, color: AppColors.onSurfaceVariant),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 16),
          Expanded(
            child: Text(title, style: AppTypography.textTheme.bodyLarge?.copyWith(color: AppColors.onSurface)),
          ),
          Switch(
            value: value,
            onChanged: onChanged,
...
class _SettingDivider extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Divider(height: 1, indent: 56, color: AppColors.outlineVariant);
  }
}
