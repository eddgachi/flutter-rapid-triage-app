...
class PatientQueueScreen extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    ...DummyData.queue.map((item) => Padding(
  ...
  Widget _buildFilterChips() {
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          _FilterChip(label: 'Priority', icon: Icons.filter_list, isActive: true),
          const SizedBox(width: 8),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          if (icon != null) ...[Icon(icon, size: 18, color: isActive ? AppColors.onSecondaryContainer : AppColors.onSurfaceVariant), const SizedBox(width: 4)],
          Text(label,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(item.name,
                            style: AppTypography.textTheme.titleMedium?.copyWith(color: AppColors.onSurface)),
                        Container(
                          ...
                          child: Text(item.triageLevel,
                              style: AppTypography.textTheme.labelMedium?.copyWith(
                                color: item.triageLevel == 'PRIORITY P3' ? Colors.black : Colors.white,
                              )),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Icon(
                              item.syncStatus == 'Synced' ? Icons.check_circle : Icons.schedule,
                              size: 16,
                              color: item.syncStatus == 'Synced' ? AppColors.primary : AppColors.onSurfaceVariant,
                            ),
                            const SizedBox(width: 4),
